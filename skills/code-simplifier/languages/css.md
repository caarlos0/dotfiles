...
- Remove dead selectors and empty rule blocks — rules orphaned when your change drops or renames a class/selector, or already-stale rules in the files you're editing. Confirm nothing in the markup/components still references them before deleting.
