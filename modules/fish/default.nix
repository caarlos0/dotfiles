{ pkgs, config, ... }: {
  ...
  xdg.configFile."fish/functions/c.fish" = {
    source = config.lib.file.mkOutOfStoreSymlink ./fish/functions/c.fish;
  };

  xdg.configFile."fish/functions/cdr.fish" = {
    source = config.lib.file.mkOutOfStoreSymlink ./fish/functions/cdr.fish;
  };

  xdg.configFile."fish/functions/certp.fish" = {
    source = config.lib.file.mkOutOfStoreSymlink ./fish/functions/cerpt.fish;
  };

  xdg.configFile."fish/functions/docker-cp.fish" = {
    source =
      config.lib.file.mkOutOfStoreSymlink ./fish/functions/docker-cp.fish;
  };

  xdg.configFile."fish/functions/gotestcovpkgs.fish" = {
    source =
      config.lib.file.mkOutOfStoreSymlink ./fish/functions/gotestcovpkgs.fish;
  };

  xdg.configFile."fish/functions/gpr.fish" = {
    source = config.lib.file.mkOutOfStoreSymlink ./fish/functions/gpr.fish;
  };

  xdg.configFile."fish/functions/gtn.fish" = {
    source = config.lib.file.mkOutOfStoreSymlink ./fish/functions/gtn.fish;
  };

  xdg.configFile."fish/functions/gwf.fish" = {
    source = config.lib.file.mkOutOfStoreSymlink ./fish/functions/gwf.fish;
  };

  xdg.configFile."fish/functions/h.fish" = {
    source = config.lib.file.mkOutOfStoreSymlink ./fish/functions/h.fish;
  };

  xdg.configFile."fish/functions/mkc.fish" = {
    source = config.lib.file.mkOutOfStoreSymlink ./fish/functions/mkc.fish;
  };

  xdg.configFile."fish/functions/myip.fish" = {
    source = config.lib.file.mkOutOfStoreSymlink ./fish/functions/myip.fish;
  };

  xdg.configFile."fish/functions/ports.fish" = {
    source = config.lib.file.mkOutOfStoreSymlink ./fish/functions/ports.fish;
  };

  xdg.configFile."fish/functions/pubkey.fish" = {
    source = config.lib.file.mkOutOfStoreSymlink ./fish/functions/pubkey.fish;
  };
}
